...
- **Download checkpoints**. The easiest way to get the required model weights is to run the provided script. This will automatically download the files from [Hugging Face](https://huggingface.co/cyberrrange/De-AntiFake) and place them in the correct directory:
  ```python
