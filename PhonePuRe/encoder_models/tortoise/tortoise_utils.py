...
DEFAULT_MEL_NORM_FILE='../speaker_encoder_ckpts/tortoise/mel_norms.pth'
BUILTIN_VOICES_DIR = 'voices'
AUTOREGRESSIVE_ENCODER = '../speaker_encoder_ckpts/tortoise/autoregressive.pth'
DIFFUSION_ENCODER = '../speaker_encoder_ckpts/tortoise/diffusion_decoder.pth'
