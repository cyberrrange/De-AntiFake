...
class RevDiffWave(torch.nn.Module):
    ...
    def audio_editing_sample(self, audio, ddpm=False):
        ...
        for it in range(self.args.sample_step):
            if self.args.diffusion_type == 'sde' and ddpm == False:
            ...
            elif self.args.diffusion_type == 'ddpm' or ddpm:
    ...
    def forward(self, x, ddpm=False):

        output = self.audio_editing_sample(x, ddpm=ddpm)
