...
from .improved_diffusion_ddpm import create_improved_diffusion
...
class RevImprovedDiffusion(torch.nn.Module):
    ...
    def __init__(self, args, config=None, device=None):
        ...
        model = create_improved_diffusion(args, self.args.diffspec_path, self.t)
        ...
        print(f't: {self.args.t}, rand_t: {self.args.rand_t}, t_delta: {self.args.t_delta}')
        print(f'use_bm: {self.args.use_bm}')
    ...
    def image_editing_sample(self, img):
        ...
        for it in range(self.args.sample_step):
            ...
            if self.args.diffusion_type == 'sde':
                ...
                x0 = melspec_inv_standardize(x_ddpm_0)
            else:
