...
output_dir=$DATA_ROOT/test_set_example_clean/audio-adaptive_protected_Adjoint
...
defense_method=DDPM # DDPM for `Adjoint` adaptive strategy in the paper
defense_t=3
defense_step=1
...
eot_size=5
diffusion_type=sde # diffusion_type=sde and defense_method=DDPM for "Adjoint" adaptive strategy in the paper
BPDA=False # True for "BPDA" adaptive strategy in the paper
