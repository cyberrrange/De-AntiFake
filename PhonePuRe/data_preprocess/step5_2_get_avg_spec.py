...
# Load config file
config = load_config('/path/to/PhonePuRe/data_preprocess/configs/libri_get_spec.json')
...
with open("/path/to/data/phoneme_avg_spec_dict/amps_avg_libri_spec.txt", "w+") as outfile:
    for p in amps_mode:
