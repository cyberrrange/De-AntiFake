...
@BackboneRegistry.register("wavenet")
class WaveNet_Speech_Commands(nn.Module):
    def __init__(self, input_channels=1, res_channels=256, skip_channels=128, out_channels=1, 
        ...
        self.init_conv = nn.Sequential(Conv(input_channels, res_channels, kernel_size=1), ReLU())
    ...
    def forward(self, audio, diffusion_steps=None):
    ...
    def add_argparse_args(parser):
        parser.add_argument("--out_channels", type=int, default=1, help="source of the model")
        return parser